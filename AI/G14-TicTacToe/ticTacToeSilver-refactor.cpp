...
// void reset_state_to(const vector<vector<IGame>>& bd,
//                     const vector<vector<bool>>& op,
//                     const vector<vector<bool>>& mn,
//                     const map<pair<int,int>, set<pair<int,int>>>& nxt,
//                     const pair<int,int>& lst) {
//     board = bd;
//     _opp = op;
//     _mine = mn;
//     _nextMoves = nxt;
